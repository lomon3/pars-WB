...
async def get_positions_by_keyword(session, keyword, art_list, total_pages, fbrand=None, max_pages_without_brand=3):
    position_dict = {art: None for art in art_list}
    #max_pages_without_brand = 3  # Ограничение на количество страниц без фильтра бренда
    page = 1
...
async def main():
    ...
    while start_stop != "stop":
        try:
            ...
            max_pages_without_brand = int(input("Введите максимальное количество страниц без фильтра бренда (по умолчанию 3): ") or 3)
